...
CREATE TABLE `FlightStatus` (
  ...
  `FlightStatus` varchar(50) DEFAULT NULL,
  `StatusDate` datetime DEFAULT NULL,
  PRIMARY KEY (`StatusID`),
  KEY `FlightID` (`FlightID`),
  CONSTRAINT `flightstatus_ibfk_1` FOREIGN KEY (`FlightID`) REFERENCES `Flights` (`FlightID`)
...
INSERT INTO `FlightStatus` VALUES (1,1,'Scheduled','2024-11-18 00:00:00'),(2,2,'Delayed','2024-11-18 00:00:00'),(3,3,'On Time','2024-11-18 00:00:00');
