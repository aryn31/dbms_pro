...
CREATE TABLE `MaintenanceAssignment` (
  ...
  KEY `TeamID` (`TeamID`),
  CONSTRAINT `maintenanceassignment_ibfk_1` FOREIGN KEY (`MaintenanceID`) REFERENCES `MaintenanceInfo` (`MaintenanceID`),
  CONSTRAINT `maintenanceassignment_ibfk_2` FOREIGN KEY (`TeamID`) REFERENCES `MaintenanceTeam` (`TeamID`)
...
INSERT INTO `MaintenanceAssignment` VALUES (1,1,1),(2,2,3),(3,3,2),(4,4,4),(5,5,3),(6,6,1);
